...
public class Constants {
    ...
    public static final String NOTEBOOK_NOTEBOOKINFO_CLU_NOTEBOOKNAME = "nbn";//列1，笔记本名字-column name
    public static final String NOTEBOOK_NOTEBOOKINFO_CLU_CREATETIME = "ct";//列2：创建笔记本时间-column name
    public static final String NOTEBOOK_NOTEBOOKINFO_CLU_STATUS = "st";//列3：笔记本状态-column name
    public static final String NOTEBOOK_NOTEBOOKINFO_CLU_NOTELIST = "nl";//列4：笔记本下笔记信息列表-column name
    /**
     * 笔记信息
     **/
    public static final String NOTE_TABLE_NAME = "n";//表名
    public static final String NOTE_FAMLIY_NOTEINFO = "ni";//列族1：笔记信息
    public static final String NOTE_NOTEINFO_CLU_NOTENAME = "nn";//列1：笔记名字-column name
    public static final String NOTE_NOTEINFO_CLU_CREATETIME = "ct";//列2：创建时间-column name
    public static final String NOTE_NOTEINFO_CLU_STATUS = "st";//列3：笔记状态-column name
    public static final String NOTE_FAMLIY_CONTENTINFO = "ci";//列族2：笔记内容
    public static final String NOTE_CONTENTINFO_CLU_CONTENT = "c";//列1：笔记内容-column name
     ...
     * 分隔符
     */
    public static final String STRING_SEPARATOR = "|";//内容分隔符
