 ...
 * 该类用于插入原始数据的数据源
 * 设计了新的rowkey和列名
 * shell脚本示例:nohup java -cp hbase-take-new-1.0-SNAPSHOT-jar-with-dependencies.jar cn.sibat.hbase.take.XiongWenHBaseWork GdRoadNew /home/public/zhengshaorong/backup/ 2017-08-01.txt >test.log &
 */
